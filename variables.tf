...
variable "postgres_user" {
  description = "The postgres user id that will be set for the RDS database instance"
  type        = string
  default     = "microservices"
}

variable "postgres_password" {
  description = "The postgres password that will be set for the RDS database instance"
  type        = string
}
